...
# run the command  scrapy crawl quotes
# scrapy shell "url"
# in
# ~/cp551/p1/tutorial/tutorial
...
class QuotesSpider(scrapy.Spider):
    ...
    start_urls = [
        ...
        #'https://www.sous-titres.eu/series/dexter.html',
        #'https://www.sous-titres.eu/series/10_things_i_hate_about_you.html',
        #'https://www.sous-titres.eu/films/hay_motivo.html'
    ]
    ...
    def parse(self, response):  
        #if not self.isClean:
            #shutil.rmtree(self.zipFileDownloadLocation)
            #shutil.rmtree(self.unzippedFileContents) 
